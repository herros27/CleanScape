...
class BotolPlastik : AppCompatActivity() {

    private var jumlahSampah = 0.0f

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_botol_plastik)
        ...
        sampah1["id_sampah"] = 1
        sampah1["nama_sampah"] = "Botol Plastik"
        ...
        angkutButton.setOnClickListener {
            ...
            val jumlahSampah = jumlahEditText.text.toString().toFloat() // Mendapatkan jumlah sampah dari EditText
            ...
            tableAngkutRef.addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    ...
                    val intent = Intent(this@BotolPlastik, UploadSampah::class.java)
        ...
        btnKumpul.setOnClickListener {
            ...
            tableCartRef.addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    ...
                    val builder = AlertDialog.Builder(this@BotolPlastik)
                    ...
                    builder.setPositiveButton("Lihat Keranjang", DialogInterface.OnClickListener { dialog, which ->
                        ...
                        val intentBag = Intent(this@BotolPlastik, Cart::class.java)
                    ...
                    builder.setNegativeButton("Tambah Sampah Lain", DialogInterface.OnClickListener { dialog, which ->
                        ...
                        jumlahSampah = 0.0f
                        jumlahEditText.setText(jumlahSampah.toString())
                        val intentAnorganik = Intent(this@BotolPlastik, Anorganik::class.java)
